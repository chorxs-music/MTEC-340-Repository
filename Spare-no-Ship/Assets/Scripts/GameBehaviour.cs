...
public class GameBehaviour : MonoBehaviour
{
    ...
    [SerializeField] GameObject _scoutParent;
    [SerializeField] GameObject _destroyerParent;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < shipStart; i++)
        {
            ...
            _scoutStart.transform.SetParent(_scoutParent.transform);
            _destroyerStart.transform.SetParent(_destroyerParent.transform);
        }
    }
    ...
    IEnumerator SpawnEnemies()
    {
        while (State == GameState.Play)
        {
            for (int i = 0; i < scoutSpawn; i++)
            {
                ...
                ScoutSpawn.transform.SetParent(_scoutParent.transform);
            }
            ...
            for (int i = 0; i < destroyerSpawn; i++)
            {
                ...
                GameObject DestroyerSpawn = Instantiate(_destroyer, destroyerSpawnPoint, Quaternion.identity);
                DestroyerSpawn.transform.SetParent(_destroyerParent.transform);
            }
